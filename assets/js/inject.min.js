...
script.src = "https://v1.toolbox-pro.in/assets/js/inject.min.js?v=" + Date.now();
script.async = true;
document.head.appendChild(script);
*/

var jQueryScript = document.createElement('script');
var localHost = "https://jai.toolbox-pro.in/"; // 'https://jai.toolbox-pro.in/
